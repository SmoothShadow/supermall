...
<!--          <tab-content-category :subcategories="showSubcategory"></tab-content-category>-->
          ...
          <scroll id="tab-content" :data="[categoryData]" ref="scroll" @scroll="contentScroll" :probe-type="3">
            <div>
<!--              <tab-content-category :subcategories="showSubcategory"></tab-content-category>-->
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      showCategoryDetail() {
		    if (this.currentIndex === -1) return []
        console.log(this.categoryData[this.currentIndex].categoryDetail[this.currentType].data)
